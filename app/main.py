...
def parse_args() -> argparse.Namespace:
    ...
    help="Voice coach gender: female (default) or male"
    )
...
def run_loop(args: argparse.Namespace) -> None:
    ...
    if voice:
        voice.speak("Voice coach initialized")
    ...
    try:
        while True:
            ...
            # zoom then mirror — both before pose estimation
            ...
            if future is not None and future.done():
                ...
                if dtw_result is not None:
                    ...
                    # voice: announce first alignment
            ...
            if key == ord("q"):
                ...
                if voice:
                    new_gender = "male" if voice._voice in ["Ava","Samantha","Nicky","Karen","Victoria"] else "female"
                    voice.set_gender(new_gender)
